...
window.server = "http://192.168.19.8:5000" 
window.server_img = window.server + "/get_imgs/"
window.server_music = window.server + "/get_musics/"
window.server_regist = window.server + "/regist/"
